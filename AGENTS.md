...
Read PRD.md, DESIGN.md, CONTENT-SOURCES.md and IMPLEMENTATION.md before changes. DESIGN.md is the only visual contract. The user selected Gallery Journey, then Crveni monolit as its revised art direction, and confirmed ADDUCO d.o.o., Metković, OIB 40912050957.
