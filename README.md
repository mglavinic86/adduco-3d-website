...
- `DESIGN.md`: sole visual contract; user selected Crveni monolit.
...
The sculpture garden is conceptual artwork, not project photography. The supplied original logo is preserved in `adduco logo/`; the public horizontal logo is a faithful Higgsfield-generated derivative. Portable GLB textures and geometry are compressed with glTF Transform (WebP and Meshopt), decoded locally without third-party runtime requests.
